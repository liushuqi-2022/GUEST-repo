...
class Andttt:
    def __init__(self):
        ...
        self.desiredCapabilities = {
            ...
            "deviceName": "emulator-5554",  # adb devices
            "newCommandTimeout": 100000,
            "appPackage": "com.github.dawidd6.andttt",
            "appActivity": "com.github.dawidd6.andttt.activities.MainActivity"
        }
...
class Sudoku:
    def __init__(self):
        ...
        self.desiredCapabilities = {
            ...
            "deviceName": "emulator-5554",  # adb devices
            "newCommandTimeout": 100000,
            "appPackage": "com.fassor.android.sudoku",
            "appActivity": "com.fassor.android.sudoku.MainActivity"
        }


class Reversi:
    def __init__(self):
        self.appname = 'reversi'
        self.desiredCapabilities = {
            "platformName": "Android",
            "deviceName": "emulator-5554",  # adb devices
            "newCommandTimeout": 100000,
            "appPackage": "uk.co.aifactory.rrfree",
            "appActivity": "uk.co.aifactory.rrfree.ReversiFreeActivity"
        }
